...
set :app_dir, '/home/test-vmeste/vmeste-app/v'
...
set :copy_exclude, ['.git/*', '.gitignore', 'config/*', 'Gemfile*', 'Capfile']
...
namespace :deploy do
	...
	task :setup_runtime do
		#run "mkdir -p #{shared_path}/runtime && chmod 775 #{shared_path}/runtime"
